...
//-----------------------------------------Applaying XOR on the 48E and 48K----------------------------------------------------------  
    ...
    public static ArrayList<String> keyGeneration(String key) {
        ArrayList<String> keyGen = new ArrayList<>();
    ...
    public static String RoundRes(String key, String pt) {
        int rounds = 16;
        String message = convertBinary(pt);
        ArrayList<String> pc2 = keyGeneration(key);
        String R = "";
        String L = "";
    ...
    public static String Encryption(String key, String pt) {
        int rounds = 16;
        String res = "";
        ArrayList<String> keyGen = keyGeneration(key);
        System.out.println(keyGen.get(0));
//        String ptres = RoundRes(keyGen.get(0), pt);
//        String ptres1 = RoundRes(keyGen.get(1), ptres);
        String temp = RoundRes(keyGen.get(0), pt);
        for (int i = 1; i < keyGen.size(); i++) {
            String ptres2 = RoundRes(keyGen.get(i), temp);
            temp = ptres2;    
        }
        return temp;
